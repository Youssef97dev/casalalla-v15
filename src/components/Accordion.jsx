    ...
    <div className="w-full">
      <div className=" font-normal px-4">
        <div className="border-t  border-secondary">
          <button
            type="button"
            className={`py-2 w-full flex items-center text-[12px] leading-[30px] tracking-widest font-light `}
          ...
          <div>
            <AnimateHeight duration={300} height={active === "1" ? "auto" : 0}>
              <div className="space-y-2 p-2 text-[12px] text-left leading-[30px] border-t border-secondary font-light tracking-widest">
